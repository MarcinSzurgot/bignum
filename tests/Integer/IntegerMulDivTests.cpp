...
TEST(IntegerMulDivTests, testThatMultiplicationOfTwoMinusesGivesPlus)
{
    // given
    const auto lhs = bignum::Integer(bignum::Sign::Minus, bignum::Unsigned{1u, 1u, 2u});
    const auto rhs = bignum::Integer(bignum::Sign::Minus, bignum::Unsigned{1u, 1u});
    const auto expected = bignum::Sign::Plus;
...
TEST(IntegerMulDivTests, testThatDivisionOfPlusesGivesPlus)
{
    // given
    const auto sign = bignum::Sign::Plus;
    const auto lhs = bignum::Integer(sign, bignum::Unsigned{1u, 1u});
...
TEST(IntegerMulDivTests, testThatDivisionOfMinusAndPlusGivesMinus)
{
    // given
    const auto minus = bignum::Integer(bignum::Sign::Minus, bignum::Unsigned{1u, 1u, 1u});
    const auto plus  = bignum::Integer(bignum::Sign::Plus,  bignum::Unsigned{1u, 1u, 1u});
...
TEST(IntegerMulDivTests, testThatDivisionOfMinusAndZeroGivesPlus)
{
    // given
    const auto zero  = bignum::Integer<unsigned>();
    const auto minus = bignum::Integer(bignum::Sign::Minus, bignum::Unsigned{1u, 1u});
...
TEST(IntegerMulDivTests, testThatDivisionOfTwoMinusesGivesPlus)
{
    // given
    const auto lhs = bignum::Integer(bignum::Sign::Minus, bignum::Unsigned{1u, 1u, 2u});
    const auto rhs = bignum::Integer(bignum::Sign::Minus, bignum::Unsigned{1u, 1u});
